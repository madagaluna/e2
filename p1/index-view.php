...
<body>
    ...
    <p> The goal of the game is to pick a time and location for all the bands to create the optimum porchfest line-up of
        ...
        longitude and
        latitude, and determine proximity to other participants based on those numbers, this game will have preset
    ...
    <ul>
        <li>Two arrays, one for location and one for time,start empty in the controller.</li>
        ...
        <li>Controller will determine whether the location and time is acceptable by running the variables against other
            scheduled performances in the location and time arrays.
